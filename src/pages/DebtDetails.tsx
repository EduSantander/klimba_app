...
import { Edit, ChevronLeft, Trash2, Plus, AlertTriangle, Crown, Calculator, TrendingUp, CheckCircle2, Info } from "lucide-react";
          ...
          <div className="lg:col-span-2 space-y-4 animate-fade-in">
            ...
            {sortedDebts.length === 0 ? (
              ...
              sortedDebts.map((debt) => {
                ...
                const remainingPercent = 100 - debtProgress;
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex-shrink-0">
                        ...
                        <p className="text-xs text-center text-muted-foreground mt-1">
                          {isPaid ? "✓ Conquistada" : `Altura: ${remainingPercent}%`}
                        </p>
                      </div>
                  ...
                  >
                    ...
                    {paymentMethod === "standard" && (
                      <div className="mt-3 space-y-3">
                        ...
                        <PaymentBreakdown
                          principal={getDebtData(selectedDebt).principal}
                          totalAmount={selectedDebt.amount}
                          months={getDebtData(selectedDebt).remainingMonths}
                          monthlyPayment={getDebtData(selectedDebt).monthlyPayment}
                          interestRate={selectedDebt.rate}
                        />
                      </div>
                    )}
                  </button>
                        ...
                        {acceleratedMonths && parseInt(acceleratedMonths) > 0 && (
                          <div className="space-y-3">
                            ...
                            <PaymentBreakdown
                              principal={getDebtData(selectedDebt).principal}
                              totalAmount={selectedDebt.amount}
                              months={parseInt(acceleratedMonths)}
