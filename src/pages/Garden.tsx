...
import { ChevronLeft, Flower2, Award, Sparkles, Info } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-background to-muted/30">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <Card className="p-6 mb-8 bg-gradient-to-r from-growth/10 to-trust/10 border-growth/20 animate-fade-in">
          <div className="flex items-start gap-4">
            <Info className="h-6 w-6 text-growth flex-shrink-0 mt-1" />
            <div>
              <h3 className="font-semibold text-foreground mb-2">¿Cómo funciona tu jardín?</h3>
              <div className="grid md:grid-cols-2 gap-4 text-sm text-muted-foreground">
                <div className="flex items-start gap-2">
                  <span className="text-lg">🌱</span>
                  <div>
                    <p className="font-medium text-foreground">Cada vez que pagas una deuda</p>
                    <p>Tu progreso histórico aumenta +1 y tu planta actual crece</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-lg">🌸</span>
                  <div>
                    <p className="font-medium text-foreground">Cada 5 deudas pagadas</p>
                    <p>Una nueva flor aparece en tu jardín y ganas una insignia</p>
                  </div>
                </div>
              </div>
            </div>
